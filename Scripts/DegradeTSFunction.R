...
# Function to shorten and degrade time series randomly
...
# Function to shorten and degrade time series, with a set number of time points 
# remaining undegraded at the end of a set percentage of time series in the dataset.
