...
# calculate species mean growth rates
growth_rate_calc_fn3 <- function(merged.matrix, c, model=FALSE) {
...
# create a database of artificial populations
pgrowth4.6 <- function(tpops, tmax, gr_mean, gr_sd_vec, popspec, sd_mean) {
...
# create a database of artificial populations with pops/species exponentially distributed
pgrowth4.7 <- function(tpops, tmax, gr_mean, gr_sd_vec, popspec, sd_mean) {
...
# create a database of artificial populations with pops/species distributed using 
# negative binomial with 1 added to each count to remove 0s
pgrowth4.8 <- function(tpops, tmax, gr_mean, gr_sd_vec, popspec, sd_mean) {
