...
LPI_full <- read.csv(file="Data/Final_dataset_withlambda_20220420.csv", sep=",", stringsAsFactors=FALSE)
...
colnames(LPI_full)[72:142] <- paste("X", colnames(LPI_full)[72:142], sep="") # full
